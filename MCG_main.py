...
axs[1,0].set_title("plots")
axs[1,1].set_title("fill between")
axs[2,0].set_title("pie x")
axs[2,1].set_title("pie y")
...
#axs[0,0].grid(axis='', color='', linestyle='')
#axs[0,1].grid(axis='', color='', linestyle='')
#axs[1,0].grid(axis='', color='', linestyle='')
